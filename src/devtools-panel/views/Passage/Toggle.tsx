...
export function Toggle(props: ToggleProps) {
  return (
    <label class="group flex cursor-pointer items-center gap-2.5 select-none">
      {props.label && (
        <span class="text-xs font-semibold tracking-wider text-slate-400 uppercase transition-colors duration-150 group-hover:text-slate-200">
          {props.label}
        </span>
      )}
      <div class="relative inline-flex items-center">
        ...
        {/* Track */}
        <div
          class="h-5 w-9 rounded-full border border-slate-700 bg-slate-900 transition-all duration-200 
...
// TODO: The code in this file was vibe-coded, I need to sanity check if we need this / if I want this
